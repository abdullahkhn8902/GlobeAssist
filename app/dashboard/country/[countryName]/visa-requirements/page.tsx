...
export default function VisaRequirementsPage() {
  ...
  const fetchData = async (refresh = false) => {
    try {
      ...
      const url = `/api/visa-requirements?country=${encodeURIComponent(countryName)}&nationality=Pakistani${refresh ? "&refresh=true" : ""}`
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-xl md:text-2xl lg:text-3xl font-bold">{countryName} Student Visa</h1>
                  <p className="text-slate-400 text-sm">For Pakistani Citizens</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-slate-700/50 rounded-lg p-3">
                  ...
                  <p className="text-white text-sm font-medium">
                    {data.financialRequirements.sponsorshipLetter ? "Required" : "Not Required"}
                  </p>
                </div>
              </div>
            </div>
